...
export function EditorHeader() {
	 ...
	 */
	return (
		<header className="flex items-center border-b border-neutral-800 bg-neutral-900/50 px-4 py-3">
			<div className="flex items-center gap-2">
				<Button
					...
					variant="ghost"
					className="text-neutral-300 hover:text-foreground hover:bg-neutral-800 disabled:opacity-50 disabled:cursor-not-allowed"
					title="Undo"
				>
